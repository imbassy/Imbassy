...
import * as sty from "./PlasmicButton.module.css" // plasmic-import: kGeIlWdAFyx5f/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__zinvN)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___0Dbsz)}
                role={"img"}
              />
            ),
