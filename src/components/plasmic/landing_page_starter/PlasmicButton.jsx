...
import * as sty from "./PlasmicButton.module.css" // plasmic-import: P_arPT46Us9VtF/css
import AppleIcon from "./icons/PlasmicIcon__Apple" // plasmic-import: dJ-8gbLjXOzDgC/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__kYmEr)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg___7KP1W)}
                role={"img"}
              />
            ),
