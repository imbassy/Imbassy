...
import * as sty from "./PlasmicPriceCard.module.css" // plasmic-import: jDVz__qBRpsrc_/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lPdma)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__j384I)}>
          <div className={classNames(projectcss.all, sty.freeBox__gd30Y)}>
            {p.renderPlasmicSlot({
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gxfHm)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__tSvFd)}>
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__sl4Ea)}>
              {p.renderPlasmicSlot({
                defaultContents: "8",
                value: args.dollars,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___4B82J)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__sDbwf)}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__dVxzE)}
                  description={
                    "Vestibulum mollis odio dictum ultrices facilisis molestie vestibulum"
                  }
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg___2Umx)}
                      role={"img"}
                    />
                  }
                />
                ...
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__m1Lv7)}
                  description={"Mus consequat a justo"}
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__vW6Ii)}
                      role={"img"}
                    />
                  }
                />
