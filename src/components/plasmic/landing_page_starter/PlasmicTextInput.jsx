...
import * as sty from "./PlasmicTextInput.module.css" // plasmic-import: fBmKM1xcoPYjsM/css
import SearchIcon from "./icons/PlasmicIcon__Search" // plasmic-import: Y6sX0PJrCAJJTR/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchIcon
                className={classNames(projectcss.all, sty.svg__yZhXc)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <CheckIcon
                className={classNames(projectcss.all, sty.svg__mHjr)}
                role={"img"}
              />
            ),
